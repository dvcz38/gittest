...
$(function(){
	...
	userInfoManage_datagrid = $("#userInfoManage_datagrid").datagrid({
		  url:ctx+"/carsensor/dtl/getall.do",
		  ...
		  columns:[[
				{width: '200',title: 'Date Time',field: 'inputDt',sortable: true},      
	          	...
	          	{width: '100',title: 'Car Status',field: 'carStatus',sortable: true} ,
	          	{width: '100',title: 'Data Type',field: 'dataType'},  
	          	{width: '100',title: 'Data Lenght',field: 'dataLen'} 
	      ]],toolbar:
	    	  ...
	    	  [{ iconCls: 'icon-add',
                ...
                handler: function(){
                    ...
                    if(ss.length==0){
                        ...
                        $.ajax({
                            type:'post',
                            url:ctx+'/carsensor/dtl/deletelist.do',
                            data:{'ids':ids},
                            dataType:"json",
	                ...
	                text:'Export All',
	                handler: function(){
	                	window.location.href=ctx+"/carsensor/dtl/export.do";
	                }
	    	  }
            ]
	});
...
//	    	},
	...
	$("#upUserForm").form({
	    type:'post',
	    url:ctx+'/carsensor/dtl/update.do',
	    dataType:"json", 
...
            type : "POST",
            dataType : "json",
            url:ctx+'/carsensor/dtl/finduser.do',
            data : {
                'page' : pageNumber,
                'rows' : pageSize
            },
